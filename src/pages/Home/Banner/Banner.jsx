...
const Banner = () => {
    return (
        <div className="min-h-screen grid grid-cols-2 bg-cover bg-fixed bg-center" style={{backgroundImage:`url('/src/assets/hero-dark.jpg')`}}>
            <div className="flex flex-col items-center justify-center">
                <h1 className="text-6xl mb-8">Jobayer Ahmed</h1>
            ...
            <div className="col-span-2 flex justify-center text-5xl text-white">
            <IoChevronDownCircle />
            </div>
        </div>
    );
